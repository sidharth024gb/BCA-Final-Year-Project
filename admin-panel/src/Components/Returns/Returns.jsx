          ...
          displayOrders.map((order) => {
            return (
              ...
              >
                ...
                <div className="order-container-group order-details col-span-3 flex-center box-2 box-hover-2">
                  ...
                  <div className="order-details-group flex-center flex-col">
                    ...
                    <p>
                      Return Status:&nbsp;
                      <span className="accent-1">
                        {capitalizeFirstLetter(order.returnStatus)}
                      </span>
                    </p>
                  </div>
                  <div className="order-details-group flex-center flex-col">
                    <p>
                      Ordered On:&nbsp;
                      <span className="accent-1">
                        {timestampToDate(order.dateOfOrder, false)}
                      </span>
                    </p>
                    <p>
                      Return Requested on:&nbsp;
                      <span className="accent-1">
                        {timestampToDate(order.dateOfReturn, false)}
                      </span>
                    </p>
                    <p>
                      Payment Method:&nbsp;
                ...
                {order.rejectionReason && order.rejectionReason !== "none" && (
                  <div className="order-container-group col-span-3 flex-center box-2 box-hover-2">
                    <p>
